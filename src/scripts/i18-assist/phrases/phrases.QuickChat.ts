...
const phrases: PhraseSet[] = [
  ...
  {
    key: "_txt_youDoNotHaveEnoughCookiesInYourWallet_f12",
    text: "You do not have enough cookies in your wallet.",
  },
  ...
  {
    key: "_txt_areYouSureYouWantToGift_617",
    text: "Are you sure you want to gift ",
  },
  { key: "_txt_CookiesTo_3ee", text: " cookies to " },
  {
    key: "_txt_milkshakeProtectsYouWhileOnlineDatingWithRefundsWithinDays_612",
  ...
  {
    key: "_txt_permanetNotRecc",
    text: "Permanent transfer are NOT recommended. You will not have refund protection.",
  },
  { key: "_txt_lbelPermant", text: "Permanent" },
  {
    key: "_txt_areYourSurePerm",
    text: "Are you sure you want to permanently transfer ",
  },
  {
    key: "_txt_cannotRefundPerm",
    text: "You will not be able to refund this transfer.",
  },
];
