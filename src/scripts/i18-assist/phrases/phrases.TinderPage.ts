...
const phrases: PhraseSet[] = [
  ...
  {
    key: "_txt_checkYourNotificationsInAMinuteToSeeConfirmationOfYourTransaction_969",
    text: "Check your notifications in a minute to see confirmation of your transaction.",
  },
  {
    key: "_txt_youHaveRefundProtection_aa2",
    text: "You have 100% refund protection",
  },
  {
    key: "_txt_milkshakeProtectsYouWithRefundGuaranteeForDays_ffa",
  ...
  {
    key: "_txt_areYouComingToMyEvent_328",
    text: "Are you coming to my event?",
  },
