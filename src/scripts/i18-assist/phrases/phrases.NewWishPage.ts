...
{ key: "_txt_wishNameMustBeLessThan_ef8", text: "Wish name must be less than " },
{ key: "_txt_charactersLength_c6d", text: "characters length" },
{ key: "_txt_wishDescriptionMustBeLessThan_982", text: "Wish description must be less than " },
...
{ key: "_txt_areYouSureToRemoveImage_395", text: "Are you sure to remove image #" },
...
{ key: "_txt_whyYouLikeThisWishOptional_b7f", text: "Why you like this wish (optional)" },
{ key: "_txt_externalLink_ceb", text: "External link" },
{ key: "_txt_linkToEventOrShoppingPage_716", text: "Link to event or shopping page" },
{ key: "_txt_priceInCookies_ea9", text: "Price in Cookies" },
{ key: "_txt_wishlistsArePurchasedWithCookiesTheInappCurrencyOfMilkshakeChatYouCanRedeemCookiesForCash_7b1", text: "Wishlists are purchased with COOKIES, the in-app currency of Milkshake Chat. You can redeem COOKIES for cash." },
{ key: "_txt_howOftenThisWishPriceWillBeChargedToTheCustomerFan_3f2", text: "How often this wish price will be charged to the customer fan." },
...
{ key: "_txt_doYouWantToAllowAnyoneToBuyThisWishOrFriendsOnly_a9e", text: "Do you want to allow anyone to buy this wish, or friends only?" },
{ key: "_txt_friendsOnly_6c8", text: "Friends Only" },
{ key: "_txt_publicMarketplace_433", text: "Public Marketplace" },
{ key: "_txt_optionalCountdownTimerForYourEventOrWish_5cc", text: "Optional countdown timer for your event or wish." },
{ key: "_txt_countdown_fae", text: "Countdown" },
{ key: "_txt_favorite_317", text: "Favorite" },
{ key: "_txt_isThisAFavoritedWishlistItem_cc3", text: "Is this a favorited wishlist item?" },
{ key: "_txt_regular_a2d", text: "Regular" },
{ key: "_txt_stickerGraphic_30e", text: "Sticker Graphic" },
{ key: "_txt_anyoneWhoBuysYourWishlistItemWillGetAnExclusiveStickerForChat_502", text: "Anyone who buys your wishlist item will get an exclusive sticker for chat" },
...
{ key: "_txt_theNameOfTheStickerThatBuyersWillSeeInTheirChats_9bc", text: "The name of the sticker that buyers will see in their chats." },
